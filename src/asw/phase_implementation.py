...
def build_development_lead_review_request(phase_label: str, turn: PhaseImplementationTurn) -> str:
    ...
    return (
        ...
        "Compare the actual changed files, implementation artifacts, and validation report against the approved turn scope. "
        ...
        "```\n\n"
        "Rules:\n"
        "- Use 'approve' only when the turn stayed in scope, the changed files are appropriate, and the validation contract remains adequate.\n"
